        ...
        <div class="container-fluid"id="id_tt">
            <div class="row text-center align-items-center justify-content-center" >
                  <img src="./uploadPhoto/22.png" alt="">
                   <img src="./uploadPhoto/temp.jpeg" class="no4" style="top: 250px;"  alt="">
                  <h1 class="name" style="top: 650px;">
                  <?php if(isset($_POST['submit'])){
                      $firstName=$_POST['Name_1'];
                        echo $firstName."<br />";
                      }?></h1> 
                  <h1 class="number" style="top: 685px;">
                    <?php if(isset($_POST['submit'])){
                      $Phone_no=$_POST['Phone_no'];
                        echo $Phone_no."<br />";
                      }?></h1>
                  <h6 class="idno" style="top: 800px;" id="dat"></h6>
            </div>
        </div>
      </section>
